...
```
              ...
              ▼                      ▼                      ▼
    ┌─────────────────┐   ┌─────────────────┐   ┌─────────────────┐
    │  개인 일정 관리    │   │  공유 캘린더      │   │   외부 연동      │
    ├─────────────────┤   ├─────────────────┤   ├─────────────────┤
    │ • 날짜 선택       │   │ • 그룹 생성      │   │ • 날씨 API      │
    │ • 일정 등록/수정   │   │ • 멤버 초대      │   │ • Google 연동   │
    │ • 일정 삭제       │   │ • 권한 관리      │   │                 │
    │ • 반복 일정 설정   │   │ • 공유 일정 표시  │   │                 │
    └─────────────────┘   └─────────────────┘   └─────────────────┘
```
...
<table>
  <tr>
    <th width="33%" align="center">🙋 사용자 편의성</th>
    <th width="33%" align="center">🤝 협업 효율성</th>
    <th width="33%" align="center">🚀 확장 가능성</th>
  </tr>
  <tr>
    <td>
      ✅ 월별 캘린더에서 직관적 일정 확인<br/>
      ✅ 반복 · 연속 일정 한 번에 관리<br/>
      ✅ 날씨 · 공휴일 · 오늘 날짜 통합 뷰
    </td>
    <td>
      ✅ 공유 캘린더로 팀원 간 일정 공유<br/>
      ✅ 그룹별 관리로 협업 효율 극대화<br/>
      ✅ 개인 · 공용 일정 깔끔한 분리
    </td>
    <td>
