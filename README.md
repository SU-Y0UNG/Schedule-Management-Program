  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        ...
        <b>▸ 반복 일정</b> — 매주 / 매월 / 매년 주기 설정<br/>
        <b>▸ 연속 일정</b> — 연속 일정 시각적 표시<br/>
    ...
    <td width="50%" valign="top">
      <h3>🤝 공유 · 연동</h3>
      <p>
        <b>▸ 공유 캘린더</b> — 그룹생성·멤버초대·권한관리<br/>
        <b>▸ 카테고리</b> — 개인 / 공용 캘린더 분리<br/>
        <b>▸ 일정 필터링</b> — 선택된 캘린더 일정만 표시<br/>
        <b>▸ 날씨 API</b> — 실시간 날씨 연동<br/>
        <b>▸ Google 연동</b> — OAuth 기반 로그인·캘린더<br/>
        <b>▸ 회원 관리</b> — 회원가입·로그인·비밀번호변경<br/>
